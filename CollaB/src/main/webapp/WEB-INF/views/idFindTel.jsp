                ...
                <div class="body__container__mid">
                    ...
                    <div class="container__mid__body">
                        ...
                        <ul class="body__input">
                            ...
                            <li>
                                <div>인증번호</div>
                                <div class="body__inputbox cnt"><input type="text"><span class="countdown">03:00</span>
                                </div>
                                <div class="body__inputBtn">인증확인</div>
                            </li>
                            <li>
                                <div></div>
                                <div class="submitBtn btn-open-popup">아이디 찾기</div>
                                <div></div>
                            </li>
        ...
        <div class="idFindModal_body">
            ...
            <div class="modal__body">
                ...
                <div class="modal__body__content">
                    <div class="content__idInput"><span> 아이디 : </span> ha3310@naver.com</div>
                    <div class="content__date"><span>가입 : </span> 2006,05,10</div>
                </div>
            </div>
