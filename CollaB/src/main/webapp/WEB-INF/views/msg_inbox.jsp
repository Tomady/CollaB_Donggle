	...
	$.ajax({
		...
		success : function(datas){
			...
			for(let data of datas){			
				...
				star.onclick = function(){ starFnc(data.inbox_id) }
...
<!-- 메시지 조회 모달 of END-->
                  ...
                  <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="search-element d-flex justify-content-between col-lg mt-2">
                      <div class="btn-group mb-2">
                        ...
                        <button id="inboxSearch" class="btn" type="button"><i class="fas fa-search"></i></button>
                      </div>
                    </div>
                  </div>
                  <div class="card-body" style="height: 100vh;">
                    <!--메시지 삭제-->
                    <button id="inboxMsgDelete" class="btn mb-2" type="button">
                    ...
                    <table id="inboxMSGlist" class="table table-hover" style="text-align: center;">
                      <thead>
                        <tr>
                          ...
                          <th scope="col" width="52%">CONTENTS</th>
                          <th scope="col" width="15%">DATE</th>
                        </tr>
                      </thead>
                      <tbody id="msgBODY">
                      <c:forEach items="${inbox}" var="inbox">
                      <c:if test="${inbox.receive_confirm == 'Y'}">
                      	<tr class="onemsgRow">
                      	  <th scope="row">
                            <input id="${inbox.inbox_id}" type="checkbox" 
                            class="onemsg" name="onemsg" onclick="checkSelect()">
                          </th>
                          <td>
                          <c:if test="${inbox.receive_star == 'Y'}">
                            <i style="color:red;" class="star fas fa-star" onclick="starFnc(${inbox.inbox_id})"></i>
                          </c:if>
                          <c:if test="${inbox.receive_star == 'N'}">
                      ...
                      <c:if test="${inbox.receive_confirm == 'N' }">
  ...
  <!--은지코드-->
  <script src="resources/js/message/inbox_message.js"></script>
